                ...
                <div class="col-xs-12">
                    ...
                    <form:form id="formEdit" commandName="model" >
                        ...
                        <div class="form-group" style=" display: none">
                            <label class="col-sm-3 control-label no-padding-right">Thêm thể loại</label>
                            <div class="col-sm-9">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                ...
                                <%-- <textarea name="description" cols="80" rows="10" id="newsDescription">${model.description}</textarea> --%>
